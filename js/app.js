...
const YARZ = (() => {
  ...
  function initHeroSlider() {
    ...
    // Changed interval to 2000ms (2s) as requested
  ...
  function renderBottomShowcase(storeInfo) {
    ...
    var isActive = String(storeInfo.promo_popup_active) === 'true';
    var img1 = storeInfo.promo_popup_image;
    var img2 = storeInfo.promo_popup_link; // repurposed link as image 2
  ...
  function init() {
    ...
    (function _smartFreshLoad() {
      var INSTANT_TTL = 15000; // 15 seconds — data this recent is "real enough"
      try {
      ...
      // Don't show skeletons immediately. Wait 350ms.
      // If Turbo data arrives within 350ms, skeletons never show → NO FLASHING/JUMPING!
      // If network is slow (>350ms), skeletons appear gracefully.
