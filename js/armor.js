...
;(function() {
  ...
  // ✅ v1.1 FIX: DISABLED on mobile/tablet devices.
  // Mobile browsers (especially Android Chrome, Samsung Internet, Firefox)
  // have variable outerWidth/innerWidth due to URL bar, bottom nav, etc.
  // This caused FALSE POSITIVE alerts scaring away real customers.
  ...
  function _checkDevTools() {
    // ✅ NEVER trigger on mobile — too many false positives
  ...
  function _onDevToolsOpen() {
    ...
    // Show a visual warning overlay — ONLY on desktop when DevTools are truly open
